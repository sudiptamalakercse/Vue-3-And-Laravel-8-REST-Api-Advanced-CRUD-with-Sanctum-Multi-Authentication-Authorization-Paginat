		...
		<div class="col-md-6">
			<div class="card">
				<form class="form-horizontal" @submit.prevent="onSignUpClick()">
					<div class="card-body">
						<h4 class="card-title mt-3 mb-3 text-center">Sign Up As Admin</h4>
...
export default {
	...
	setup() {
		...
		cheange_breadcrumb_heading_and_title_heading('Sign Up As Admin');

		cheange_breadcrumb_links([
			{ name: 'Admin & User Portal', name_of_route: 'home', disabled: false },
			{
				name: 'Sign Up As Admin',
				name_of_route: 'sign_up_admin',
				disabled: true
			}
		]);
